...
import { saveProformaInvoiceAction, type ProformaInvoiceFormState } from "./actions";

const initialState: ProformaInvoiceFormState = {};
...
export type ProformaInvoiceFormDefaultValues = {
  customerId: string;
  proformaDate: string;
  dueDate: string;
...
export function ProformaInvoiceForm({
  ...
  defaultValues?: ProformaInvoiceFormDefaultValues;
}) {
  const [state, formAction] = useActionState(saveProformaInvoiceAction, initialState);
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      {proformaInvoiceId ? <input type="hidden" name="proformaInvoiceId" value={proformaInvoiceId} /> : null}
          ...
          <FieldGroup>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <FormField
                ...
                type="date"
                required
                defaultValue={defaultValues?.proformaDate ?? new Date().toISOString().slice(0, 10)}
                error={state.fieldErrors?.proformaDate}
              />
              <FormField
                label="Due date"
                name="dueDate"
      ...
      <Card>
        <CardContent>
          <Field>
            <FieldLabel htmlFor="bankAccountId">Bank account (shown on proforma invoice)</FieldLabel>
            <SelectField
              name="bankAccountId"
