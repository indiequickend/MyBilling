...
/** Inline split-payment recording at document save time — only submitted when the document is
 * finalized (see InvoiceForm/PurchaseForm's "Save"/"Save & Print" intents). */
